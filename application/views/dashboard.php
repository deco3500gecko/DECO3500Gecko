...
<head>
	...
	.lines {
		animation: animateLines ease 6s;
		z-index: 1;
	}
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								?>
								class="<?php echo $student->team; ?>-checkbox">
							</td>
						</tr>
						<?php } ?>
					</tbody>
		...
		<div id="page-content-wrapper">
            ...
            <div id="main">
				...
				<div class="scene">
					...
					<svg height="1000" width="2000" class="lines">
						<line x1="<?php echo 300 + $red_points * 3; ?>" y1="<?php echo 1000 - $red_points * 6.65 - 230; ?>" x2="635" y2="50" stroke-dasharray="10,10" style="stroke:rgb(255,255,255);stroke-width:4" />
						<line x1="<?php echo 580 + $yellow_points * 1; ?>" y1="<?php echo 1000 - $yellow_points * 6 - 240; ?>" x2="700" y2="50" stroke-dasharray="10,10" style="stroke:rgb(255,255,255);stroke-width:4" />
						<line x1="<?php echo 855 - $green_points * 1; ?>" y1="<?php echo 1000 - $green_points * 6 - 240; ?>" x2="740" y2="50" stroke-dasharray="10,10" style="stroke:rgb(255,255,255);stroke-width:4" />
						<line x1="<?php echo 1135 - $blue_points * 3; ?>" y1="<?php echo 1000 - $blue_points * 6.65 - 230; ?>" x2="805" y2="50" stroke-dasharray="10,10" style="stroke:rgb(255,255,255);stroke-width:4" />
					</svg>
				</div>
